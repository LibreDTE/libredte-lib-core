...
class FormasDePagoExportacionRepositoryTest extends TestCase
{
    private FormasDePagoExportacionRepository $repository;

    protected function setUp(): void
    {
        $this->repository = new FormasDePagoExportacionRepository();
    }
