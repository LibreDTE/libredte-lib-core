...
#[CoversClass(ListDocumentEventsJob::class)]
#[CoversClass(ListDocumentEventsResponse::class)]
class ListDocumentEventsTest extends TestCase
{
    ...
    public function testListDocumentEvents(): void
    {
        $response = $this->siiRcvWorker->listDocumentEvents(
            $this->siiRequest,
            '76192083-9',
            33,
            747
