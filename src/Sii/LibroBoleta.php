 ...
 */
class LibroBoleta extends \libredte\lib\Sii\Base\Libro
{
    ...
    public function setCaratula(array $caratula)
    {
        ...
        $this->id = 'LibreDTE_LIBRO_BOLETA_' . str_replace('-', '', $this->caratula['RutEmisorLibro'])
     ...
     * @return string XML con el envio del libro de boletas firmado o =false si no se pudo generar o firmar el libro.
     */
    public function generar(): string
    {
        ...
        $this->xml_data = $this->Firma
            ...
            : $xmlEnvio
        ;
        // Parche porque SII usa su propio namespace para la firma en las boletas.
        $this->xml_data = str_replace(
