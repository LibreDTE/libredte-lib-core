...
use libredte\lib\Core\Sii\Dte\Documento\NotaCreditoExportacion;
 ...
 */
class NotaCreditoExportacionBuilder extends AbstractDocumentoBuilder
{
     ...
     * @var string
     */
    protected string $documentoClass = NotaCreditoExportacion::class;
