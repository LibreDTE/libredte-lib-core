...
use libredte\lib\Core\Sii\Dte\Documento\BoletaAfecta;
 ...
 */
class BoletaAfectaBuilder extends AbstractDocumentoBuilder
{
     ...
     * @var string
     */
    protected string $documentoClass = BoletaAfecta::class;
