...
use libredte\lib\Core\Sii\Dte\Documento\FacturaCompra;
 ...
 */
class FacturaCompraBuilder extends AbstractDocumentoBuilder
{
     ...
     * @var string
     */
    protected string $documentoClass = FacturaCompra::class;
