 ...
 * @link http://comext.aduana.cl:7001/codigos
 * @link https://www.aduana.cl/compendio-de-normas-anexo-51/aduana/2008-02-18/165942.html
 */
class Aduana
{
    ...
    private static function getTablasInvertidas()
    {
        ...
        foreach (self::$tablas as $tag => $info) {
            if (is_string($info) || (!isset($info['valor']) && !isset($info['tabla']))) {
                continue;
            }
