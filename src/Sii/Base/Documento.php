...
abstract class Documento
{
     ...
     * @version 2015-12-14
     */
    public function setFirma(\libredte\lib\FirmaElectronica $Firma)
    {
        $this->Firma = $Firma;
    }
    ...
    public function schemaValidate()
    {
        if (!$this->xml_data) {
            \libredte\lib\Log::write(
                \libredte\lib\Estado::DOCUMENTO_FALTA_XML,
        ...
        if (!$schema or !is_readable($xsd)) {
            \libredte\lib\Log::write(
                \libredte\lib\Estado::DOCUMENTO_FALTA_SCHEMA,
                \libredte\lib\Estado::get(
                    \libredte\lib\Estado::DOCUMENTO_FALTA_SCHEMA
                )
            );
        ...
        if (!$result) {
            \libredte\lib\Log::write(
                \libredte\lib\Estado::DOCUMENTO_ERROR_SCHEMA,
                \libredte\lib\Estado::get(
                    \libredte\lib\Estado::DOCUMENTO_ERROR_SCHEMA,
                    substr(get_class($this), strrpos(get_class($this), '\\')+1),
                    implode("\n", $this->xml->getErrors())
