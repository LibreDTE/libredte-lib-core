...
class Cesion
{
    ...
    {
        $this->datos['Cesion']['DocumentoCesion']['Cedente'] = \libredte\lib\Arreglo::mergeRecursiveDistinct([
        ...
        if (!empty($this->datos['Cesion']['DocumentoCesion']['Cedente']['RUTAutorizado']['Nombre'])) {
            $this->datos['Cesion']['DocumentoCesion']['Cedente']['RUTAutorizado']['Nombre'] = mb_substr(
                $this->datos['Cesion']['DocumentoCesion']['Cedente']['RUTAutorizado']['Nombre'], 0, 40
            );
        }
    ...
    {
        $xml_unsigned = (new \libredte\lib\XML())->generate($this->datos)->saveXML();
    ...
    /**
     * Método que entrega el string con el XML de la cesión.
     */
     ...
     * @return bool =true si el schema del documento del DTE es válido, =null si no se pudo determinar
     */
    public function schemaValidate()
    {
        // TODO: implementar método (requiere usar XML firmado y esquema SII)
        return true;
    }
     ...
     * @return \libredte\lib\XML Objeto XML
     */
