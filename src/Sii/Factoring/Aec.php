 ...
 * @version 2016-12-10
 */
class Aec extends \libredte\lib\Sii\Base\Envio
{
     ...
     * @param DteCedido Objeto de \libredte\lib\Sii\Factoring\DteCedido
     * @version 2016-12-10
     */
     ...
     * @param Cesion Objeto de \libredte\lib\Sii\Factoring\Cesion
     * @version 2016-12-10
     */
    ...
    private function enviarRTC($email, $empresa, $dte, $token, $retry = null)
    {
        ...
        $url = 'https://'.\libredte\lib\Sii::getServidor().'.sii.cl/cgi_rtc/RTC/RTCAnotEnvio.cgi';
        ...
        if (!\libredte\lib\Sii::getVerificarSSL()) {
            if (\libredte\lib\Sii::getAmbiente()==\libredte\lib\Sii::PRODUCCION) {
                \libredte\lib\Log::write(
                    ...
                    \libredte\lib\Estado::get(\libredte\lib\Estado::ENVIO_SSL_SIN_VERIFICAR),
                    LOG_WARNING
                );
            }
        ...
        if (!$response or $response == 'Error 500') {
            if (!$response)
                \libredte\lib\Log::write(\libredte\lib\Estado::ENVIO_ERROR_CURL, \libredte\lib\Estado::get(\libredte\lib\Estado::ENVIO_ERROR_CURL, curl_error($curl)));
            if ($response == 'Error 500')
                \libredte\lib\Log::write(\libredte\lib\Estado::ENVIO_ERROR_500, \libredte\lib\Estado::get(\libredte\lib\Estado::ENVIO_ERROR_500));
            return false;
        }
        // cerrar sesión curl
        curl_close($curl);
        ...
        try {
            ...
            \libredte\lib\Log::write(\libredte\lib\Estado::ENVIO_ERROR_XML, \libredte\lib\Estado::get(\libredte\lib\Estado::ENVIO_ERROR_XML, $e->getMessage()));
            return false;
        }
        /*
         * 0 Envío recibido OK.
