...
class Estado
{
    ...
    // códigos de error para \libredte\lib\Sii::enviar()
    const ENVIO_OK = 0;
    ...
    // códigos de error para \libredte\lib\Sii::request()
    const REQUEST_ERROR_SOAP = 61;
    const REQUEST_ERROR_BODY = 62;

    // códigos de error para \libredte\lib\Sii::cert()
    const SII_ERROR_CERTIFICADO = 71;

    // códigos de error para \libredte\lib\FirmaElectronica
    const FIRMA_ERROR = 101;

    // códigos de error para \libredte\lib\File::compress()
    const COMPRESS_ERROR_READ = 201;
    const COMPRESS_ERROR_ZIP = 202;

    // códigos de error para \libredte\lib\Sii\Autenticacion
    const AUTH_ERROR_SEMILLA = 301;
    const AUTH_ERROR_FIRMA_SOLICITUD_TOKEN = 302;
    const AUTH_ERROR_TOKEN = 303;

    // códigos de error para \libredte\lib\Sii\Dte
    ...
    // códigos de error para \libredte\lib\Sii\EnvioDte
    ...
    // códigos de error para \libredte\lib\Sii\EnvioRecibos
    const ENVIORECIBOS_FALTA_RECIBO = 601;
    const ENVIORECIBOS_FALTA_CARATULA = 602;

    // códigos de error para \libredte\lib\Sii\Folios
    ...
    // códigos de error para \libredte\lib\Sii\RespuestaEnvio
    const RESPUESTAENVIO_FALTA_RESPUESTA = 801;
    const RESPUESTAENVIO_FALTA_CARATULA = 802;

    // códigos de error para \libredte\lib\Sii\Base\Documento
    ...
    private static $glosas = [
        ...
        // códigos de error para \libredte\lib\Sii\LibroGuia
