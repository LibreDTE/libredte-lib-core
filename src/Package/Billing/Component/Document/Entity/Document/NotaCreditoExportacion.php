 ...
 */
class NotaCreditoExportacion extends AbstractDocument implements NotaCreditoExportacionInterface
{
    /**
     * Código del tipo de documento tributario al que está asociada esta
     * instancia de un documento.
     */
    protected CodigoDocumento $tipoDocumento = CodigoDocumento::NOTA_CREDITO_EXPORTACION;
}
