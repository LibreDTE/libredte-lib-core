 ...
 */
class FacturaExportacion extends AbstractDocument implements FacturaExportacionInterface
{
    /**
     * Código del tipo de documento tributario al que está asociada esta
     * instancia de un documento.
     */
    protected CodigoDocumento $tipoDocumento = CodigoDocumento::FACTURA_EXPORTACION;
}
