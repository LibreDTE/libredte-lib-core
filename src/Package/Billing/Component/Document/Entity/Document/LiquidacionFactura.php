 ...
 */
class LiquidacionFactura extends AbstractDocument implements LiquidacionFacturaInterface
{
    /**
     * Código del tipo de documento tributario al que está asociada esta
     * instancia de un documento.
     */
    protected CodigoDocumento $tipoDocumento = CodigoDocumento::LIQUIDACION_FACTURA;
}
