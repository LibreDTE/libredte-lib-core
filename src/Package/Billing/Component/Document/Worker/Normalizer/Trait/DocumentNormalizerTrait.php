...
/**
 * Reglas de normalización generales para todos los documentos tributarios.
 */
trait DocumentNormalizerTrait
{
     ...
     * @return void
     */
    protected function preNormalizeDocument(DocumentBagInterface $bag): void
    {
     ...
     * @return void
     */
    protected function postNormalizeDocument(DocumentBagInterface $bag): void
    {
        $data = $bag->getNormalizedData();
