...
use libredte\lib\Core\Package\Billing\Component\Document\Contract\Sanitizer\Strategy\NotaCreditoExportacionSanitizerStrategyInterface;

/**
 * Sanitizador del documento nota de crédito de exportación.
 */
#[Strategy(name: 'nota_credito_exportacion', worker: 'sanitizer', component: 'document', package: 'billing')]
