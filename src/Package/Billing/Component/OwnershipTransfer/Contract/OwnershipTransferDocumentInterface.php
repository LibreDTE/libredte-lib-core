...
/**
 * Interfaz para los documentos de cesión electrónica (AEC).
 *
 * El documento es una vista sobre el `XmlDocumentInterface` que lo contiene;
 * todos los datos se derivan del XML. Implementada por `Aec`, `DteCedido` y
 * `Cesion`.
 */
interface OwnershipTransferDocumentInterface extends JsonSerializable
{
    /**
    ...
    /**
     * Genera el XML del documento de cesión como string incluyendo
     * encabezado.
     *
     * @return string
    ...
    /**
     * Genera el XML del documento de cesión como string sin encabezado ni
