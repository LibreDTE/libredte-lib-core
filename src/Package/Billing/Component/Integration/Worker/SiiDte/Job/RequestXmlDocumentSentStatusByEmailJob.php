...
namespace libredte\lib\Core\Package\Billing\Component\Integration\Worker\SiiDte\Job;
 ...
 */
#[Job(name: 'request_xml_document_sent_status_by_email', worker: 'sii_dte', component: 'integration', package: 'billing')]
