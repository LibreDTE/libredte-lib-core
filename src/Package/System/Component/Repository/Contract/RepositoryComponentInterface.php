...
/**
 * Interfaz para `RepositoryComponent`.
 */
interface RepositoryComponentInterface extends ComponentInterface
{
    /**
     * Entrega el worker "system.repository.catalog".
     *
     * @return CatalogWorkerInterface
     */
